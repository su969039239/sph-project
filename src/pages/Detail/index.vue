          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(saleAttr,index) in spuSaleAttrList" :key="index">
                ...
                <dd changepirce="0" :class="{active: saleAttrValue.isChecked === '1' }" v-for="(saleAttrValue,index) in saleAttr.spuSaleAttrValueList" :key="saleAttrValue.id" @click="changeActive(saleAttrValue,saleAttr.spuSaleAttrValueList)">{{saleAttrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.$store.dispatch("reqGetGoodsDetail",this.$route.params.skuId)
    },
    ...
    methods: {
      ...
      async addOrUpdateCart() {
        try {
          await this.$store.dispatch("addOrUpadteGoods", {
